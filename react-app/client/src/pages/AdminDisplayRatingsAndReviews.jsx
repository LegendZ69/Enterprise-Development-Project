...
function AdminDisplayRatingsAndReviews() {
            ...
            {userProfile && user.role == "admin" ? (
                <Box display="flex">
                    ...
                    <Box flex={1} sx={{ alignContent: 'center', textAlign: 'center' }}>
                        ...
                        <Link to="/adminDisplayRatingsAndReviews"><Typography sx={{ fontWeight: 'bold' }}>Admin Reviews</Typography></Link>
                    </Box>
                                    ...
                                    <Card>
                                        <CardContent>
                                            <Box sx={{ display: 'flex' }}>
                                                ...
                                                <Link to={`/adminEditRatingsAndReviews/${ratingsAndReviews.id}`}>
...
export default AdminDisplayRatingsAndReviews